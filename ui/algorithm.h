...
// Basic Fault Tolerant Shape Formation.
class ShapeFormationFaultTolerantAlg : public Algorithm {
  Q_OBJECT

 public:
  ShapeFormationFaultTolerantAlg();
...
// Basic Fault Tolerant Leader Election.
class LeaderElectionFaultTolerantAlg : public Algorithm {
  Q_OBJECT

 public:
  LeaderElectionFaultTolerantAlg();
...
class ChiralityComparisonAlg : public Algorithm {
  Q_OBJECT

 public:
  ChiralityComparisonAlg();
