...
const std::vector<int> LocalParticle::tailExclusiveLabels() const {
    Q_ASSERT(isExpanded());

    int rearLabel = dirToTailLabel(tailDir());
    std::vector<int> labels{(rearLabel + 9) % 10, rearLabel, (rearLabel + 1) % 10};
