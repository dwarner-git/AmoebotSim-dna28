...
class LocalParticle : public Particle {
 public:
  ...
  // Functions for accessing labels specifically incident to the head or tail.
  ...
  // Returns the labels that refer to nodes, which are incident to the tail but not to the head.
  const std::vector<int> tailExclusiveLabels() const;
